...
URI = config['DEFAULT']['URL_API_BDP_CLUSTER_2']
...
def bdp_cluster_1 ():
    try:
        ...
        if response.status_code != 200:
            logging.error('BDPv4 CLUSTER 2 ERROR EL ENDPOINT NO RESPONDE OK :'+str(e))
            ...
            logging.info("Diccionario bdpv4 CLUSTER2:")
        ...
        status = 0
        logging.error('BDP4 CLUSTER2 ERROR AL PROCESAR REQUEST :'+str(e))
